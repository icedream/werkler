...
func TestRunPrompt_SimpleResponse(t *testing.T) {
	...
	result, err := chat.RunPrompt(t.Context(), c, s, "ping", chat.PromptOptions{})
...
func TestRunPrompt_AIError(t *testing.T) {
	...
	s := newTestSession(tm, nil)
	_, err := chat.RunPrompt(t.Context(), c, s, "hello", chat.PromptOptions{})
	require.Error(t, err)
...
func TestRunPrompt_ApprovedToolCall(t *testing.T) {
	...
	result, err := chat.RunPrompt(t.Context(), c, s, "read the file", chat.PromptOptions{})
	require.NoError(t, err)
...
func TestRunPrompt_UnapprovedToolCall_DenialFedBack(t *testing.T) {
	...
	result, err := chat.RunPrompt(t.Context(), c, s, "do something dangerous", chat.PromptOptions{})
	require.NoError(t, err)
...
func TestRunPrompt_MaxStepsExceeded(t *testing.T) {
	...
	_, err := chat.RunPrompt(t.Context(), c, s, "loop forever", chat.PromptOptions{})
	require.Error(t, err)
...
func TestRunPrompt_ToolsError(t *testing.T) {
	...
	s := newTestSession(tm, nil)
	_, err := chat.RunPrompt(t.Context(), &mockCompleter{}, s, "hi", chat.PromptOptions{})
	require.Error(t, err)
